    ...
    >
      ...
      <div className="relative flex flex-col text-center px-4 sm:px-8 md:px-16">
        ...
        <p className="text-lg text-white/80 md:w-[40%] mx-auto mt-4">
          At Our, we specialize in connecting businesses across the globe. With
          years of experience in import and export, we pride ourselves on
          delivering reliable, efficient, and transparent services that make
          international trade simple and stress-free. Our team is committed to
          helping your business grow worldwide.
        </p>
      </div>
    </div>
  );
